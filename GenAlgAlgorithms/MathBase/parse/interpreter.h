...
public:
    ...
    */
    ...
    /**
    * Returns all nodes of all trees, created during scanning and parsing; 
    * Used to prevent memory leaks if nodes are allocated, but the tree is not generated
    */
